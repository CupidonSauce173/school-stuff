...
# Date de dernière modification : A2022
...
def saisir_un_nombre(p_message:str)->tuple  :
    ...
    Retour : un tuple composé du nombre saisi par l'utilisateur et une chaine de caractères contenant le type (int ou float)
    ...
    while True:
        ...
        try:            
            ...
            elif float(un_nombre) :            
                return( un_nombre, "float" )
            #end if
        except :                        
            print('==> Attention : Erreur de saisie, saisir un nombre (entier ou réel), réessayer \n')
    #end while
    ...
    while True:    
        try:
            ...
            if un_nombre >= p_mini and un_nombre <= p_maxi:
                ...
                print('==>', p_message, "(doit être un réel compris entre", p_mini, "et", p_maxi, ") réessayer \n")
            #end if
        except :
            print("==> Erreur de saisie (doit être un réel compris entre", p_mini, "et", p_maxi, ") réessayer \n")
    #end while
#...........................................................................................................................
    ...
    while True:    
        try:
            ...
            if un_nombre >= p_mini and un_nombre <= p_maxi:
                ...
                print('==>', p_message, "(doit être un entier compris entre", p_mini, "et", p_maxi, ") réessayer \n")
            #end if
        except ValueError as erreur :
            print("==> Erreur de saisie, (doit être un entier compris entre", p_mini, "et", p_maxi, ") réessayer \n")
    #end while
